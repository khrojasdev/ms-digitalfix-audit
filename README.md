...
Auditoria: bitacora inmutable de eventos de negocio para trazabilidad y cumplimiento.

## Tecnologias

Spring Boot 3, Kafka, Spring Data JPA, Oracle
...
- [`digitalfix-ms-auditoria`](https://github.com/khrojasdev/digitalfix-ms-auditoria) - Microservicio **(este)**
